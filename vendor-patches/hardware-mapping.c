...
struct HardwareMapping matrix_hardware_mappings[] = {
  /*
   * SEENGREAT RGB Matrix Adapter Board (HUB75, including E for 1:32 scan).
   * This currently matches the upstream "regular" pin-out, but is named
   * explicitly so SkyHi's configuration is self-documenting.
   */
  {
    .name          = "seengreat",
